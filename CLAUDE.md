...
- **Direct Anthropic-compatible** (Kimi, Z.ai GLM): `unset ANTHROPIC_API_KEY`, set `ANTHROPIC_AUTH_TOKEN` to the provider key, point `ANTHROPIC_BASE_URL` at the provider. Minimal; no profile.
